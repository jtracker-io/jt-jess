...
def _get_workflow_by_name(workflow_owner_name, workflow_name, workflow_version=None):
...
def create_queue(owner_name, workflow_name, workflow_version, workflow_owner_name):
    ...
    workflow = _get_workflow_by_name(workflow_owner_name, workflow_name, workflow_version)
